...
AtliQ Hardware is growing rapidly in the recent years, and they have decided to implement the data analytics using PowerBi and SQL in their company for the first time to surpass their competitors in the market and to make data driven decisions. This project is hoped to give answers to the questions of stakeholder in terms all the aspects like finance, sales, marketing and supply chain.
...
Based on the mock ups received as requirement, i will start designing the visuals and create measure as and when required.
